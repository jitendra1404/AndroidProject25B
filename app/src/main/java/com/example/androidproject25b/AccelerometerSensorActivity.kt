...
class AccelerometerSensorActivity : AppCompatActivity(), SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvAcceleroemter = findViewById(R.id.tvAccelerometer)
    ...
    override fun onSensorChanged(event: SensorEvent?) {
        ...
        if (event?.sensor?.type == Sensor.TYPE_ACCELEROMETER) {
            ...
            tvAcceleroemter.setBackgroundColor(color)

            tvAcceleroemter.text = "up/down ${upDown.toInt()}\nleft/right ${sides.toInt()}"
        }
    }
